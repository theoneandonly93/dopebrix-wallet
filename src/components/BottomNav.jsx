...
export default function BottomNav({ value, onChange }) {
  // Use global navigation handler for all tab clicks
  const handleTab = (tabName) => {
    if (window.__setAppTab) window.__setAppTab(tabName);
    else if (onChange) onChange(tabName);
  };
  return (
    <nav className="bottom-nav">
      <div className={`bottom-item ${value === 'wallet' ? 'active' : ''}`} onClick={() => handleTab('wallet')}>
        <Icon name="wallet" />
        Wallet
      </div>
      <div className={`bottom-item ${value === 'collectibles' ? 'active' : ''}`} onClick={() => handleTab('collectibles')}>
        <Icon name="collect" />
        Collectibles
      </div>
      <div className={`bottom-item ${value === 'earn' ? 'active' : ''}`} onClick={() => handleTab('earn')}>
        <Icon name="earn" />
        Earn
      </div>
      <div className={`bottom-item ${value === 'activity' ? 'active' : ''}`} onClick={() => handleTab('activity')}>
        <Icon name="activity" />
        Activity
      </div>
      <div className={`bottom-item ${value === 'explore' ? 'active' : ''}`} onClick={() => handleTab('explore')}>
        <Icon name="explore" />
        Explore
      </div>
    </nav>
